...
<>
    ...
    <div style={{display: 'flex', flexDirection: 'column', gap: '10px', position: 'absolute', left: '50%', bottom: '10px', transform: 'translateX(-50%)'}}>
      <img src={som2} alt="cd2" style={{width: '200px', height: '100px'}} />
    </div>
    <div style={{display: 'flex', flexDirection: 'row', gap: '10px', position: 'absolute', bottom: '10px', right: '10px'}}>
      <img src={som} alt="giphy" style={{width: '100px', height: '170px'}}/>
    </div>
    <div style={{display: 'flex', flexDirection: 'column', gap: '10px', position: 'absolute', left: '50%', bottom: '10px', transform: 'translateX(-50%)'}}>
